...
write_csv(results, here('results/ALMANAC_klaeger_models/prostate_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
...
write_csv(results, here('results/ALMANAC_klaeger_models/prostate_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results_rf.csv'))
