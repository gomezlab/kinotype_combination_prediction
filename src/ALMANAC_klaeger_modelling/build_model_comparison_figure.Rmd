...
data_paths_combined = data_paths %>%
  ...
  bind_rows(tribble(
    ~cancer_type, ~model_type, ~data_path,
                    "breast", "xgboost", here('results/ALMANAC_klaeger_johnson_models/breast_cancer_models/ALMANAC_klaeger_johnson_lasso_xgboost_all_tuning_results_all_kinases_forced_in.csv'),
                    "pan-cancer", "xgboost", here('results/ALMANAC_klaeger_johnson_models/pan_cancer_models/ALMANAC_klaeger_johnson_lasso_xgboost_all_tuning_results_truncated.csv')
    )
  )
