---
title: "ALMANAC_modelling_melanoma"
...
```{r}
#read in data 
ALMANAC_klaeger_CCLE_data = read_rds(here('results/ALMANAC_klaeger_models/melanoma_cancer_models/ALMANAC_klaeger_data_for_ml_melanoma.rds.gz'))
...
write_csv(results, here('results/ALMANAC_klaeger_models/melanoma_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
```
...
write_csv(results, here('results/ALMANAC_klaeger_models/melanoma_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results_rf.csv'))
```