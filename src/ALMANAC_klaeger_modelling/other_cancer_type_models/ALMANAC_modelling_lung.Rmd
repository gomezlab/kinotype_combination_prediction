...
```{r}
#read in data 
ALMANAC_klaeger_CCLE_data = read_rds(here('results/ALMANAC_klaeger_models/lung_cancer_models/ALMANAC_klaeger_data_for_ml_lung.rds.gz'))
...
write_csv(results, here('results/ALMANAC_klaeger_models/lung_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
```
...
write_csv(results, here('results/ALMANAC_klaeger_models/lung_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results_rf.csv'))
```

```{r}
#fit model on whole data to get importances

results = read_csv(here('results/ALMANAC_klaeger_models/lung_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
...
write_csv(here('results/ALMANAC_klaeger_models/lung_cancer_models/lasso_selected_features.csv'))
```

```{r}
# fit best model with CV for figure
lasso_selected_features = read_csv(here('results/ALMANAC_klaeger_models/lung_cancer_models/lasso_selected_features.csv')) %>% 
  filter(Importance > 0)
...
ggsave(here('figures/ALMANAC_klaeger/lung_ALMANAC_klaeger_best_model_CV.png'))
```