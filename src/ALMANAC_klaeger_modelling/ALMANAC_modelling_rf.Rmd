---
title: "ALMANAC modelling with random forest"
...
```{r}
#read in data 
ALMANAC_klaeger_CCLE_data = read_csv(here('results/ALMANAC_klaeger_models/ALMANAC_klaeger_data_for_ml.csv'))
...
write_csv(results, here('results/ALMANAC_klaeger_models/ALMANAC_klaeger_lasso_random_forest_all_tuning_results.csv'))
```
...
results = read_csv(here('results/ALMANAC_klaeger_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results.csv'))
...
write_csv(here('results/ALMANAC_klaeger_models/lasso_selected_features.csv'))
```

```{r}
# fit best model with CV for figure
lasso_selected_features = read_csv(here('results/ALMANAC_klaeger_models/lasso_selected_features.csv')) %>% 
  filter(Importance > 0)
...
ggsave(here('figures/ALMANAC_klaeger/ALMANAC_klaeger_best_model_CV.png'))
```
