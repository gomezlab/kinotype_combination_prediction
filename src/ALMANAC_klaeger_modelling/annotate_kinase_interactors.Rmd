...
```{r}
model_features = data.frame(temp = names(ALMANAC_klaeger_CCLE_data)) %>%
...
write_rds(model_features,here('results/ALMANAC_klaeger_models/expression_feature_interactors.rds'))
```
