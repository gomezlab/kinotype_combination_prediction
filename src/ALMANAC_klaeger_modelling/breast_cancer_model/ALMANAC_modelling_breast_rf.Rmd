...
write_csv(results, here('results/ALMANAC_klaeger_models/breast_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results_rf.csv'))
```

```{r}
#fit model on whole data to get lasso feature coefficients 

results = read_csv(here('results/ALMANAC_klaeger_models/breast_cancer_models/ALMANAC_klaeger_lasso_xgboost_all_tuning_results_rf.csv'))
...
ggsave(here('figures/ALMANAC_klaeger/breast_ALMANAC_klaeger_best_model_CV_rf.png'))
```
