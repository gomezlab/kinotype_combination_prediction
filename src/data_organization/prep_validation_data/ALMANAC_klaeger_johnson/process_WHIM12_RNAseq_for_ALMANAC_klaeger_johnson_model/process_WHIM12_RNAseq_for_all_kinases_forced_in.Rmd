...
WHIM12_exp_data_for_model = WHIM12_exp %>% 
  ...
  mutate(cell_line = "WHIM12",
	...
	write_rds(here('data/Synergy_data_collection/usable_data/sam_usable/RNAseq/WHIM12_RNAseq_data_for_ALMANAC_klaeger_johnson_all_kinases_forced_in.rds'))
```
