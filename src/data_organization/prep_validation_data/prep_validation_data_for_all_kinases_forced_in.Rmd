...
WHIM12_exp_data = read_rds(here('data/Synergy_data_collection/usable_data/sam_usable/RNAseq/WHIM12_RNAseq_data_for_all_kinases_forced_in.rds')) %>% 
...
validation_klaeger_exp_data = validation_klaeger_data %>% 
  ...
  write_csv(here('results/ALMANAC_klaeger_models/breast_cancer_models/validation/validation_klaeger_exp_data_for_all_kinases_forced_in.csv'))
```
