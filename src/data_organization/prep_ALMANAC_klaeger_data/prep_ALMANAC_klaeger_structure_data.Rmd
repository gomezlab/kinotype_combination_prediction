---
title: "prep_ALMANAC_klaeger_structure_data"
...
matched_ALMANAC_drugs = read_csv(here('src/data_organization/find_ALMANAC_klaeger_matches/ALMANAC_klaeger_matches.csv'))
...
klaeger_structure_features = read_csv(here('data/klaeger_physiochem_feats.csv')) %>% 
	rename(cid = CID) %>% 
	rename_with(~paste0("str_",.), -starts_with("cid"))
```
