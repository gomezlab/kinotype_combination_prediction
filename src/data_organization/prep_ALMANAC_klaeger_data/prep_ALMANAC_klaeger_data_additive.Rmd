...
klaeger_combinations = read_rds(here('results/ALMANAC_klaeger_models/klaeger_combos/ALMANAC_klaeger_synergy_combos_additive.rds')) %>% 
...
write_csv(dose_matches, here('results/matching/ALMANAC_klaeger_dose_matches.csv'))
```
...
write_csv(ALMANAC_nearest_klaeger_doses, here('results/matching/ALMANAC_nearest_klaeger_doses.csv'))
...
write_csv(this_dataset, here('results/ALMANAC_klaeger_data_for_ml_additive.csv'))
