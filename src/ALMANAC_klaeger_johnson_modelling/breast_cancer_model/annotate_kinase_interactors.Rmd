...
```{r}
model_features = data.frame(temp = names(ALMANAC_klaeger_johnson_CCLE_data)) %>%
...
write_rds(model_features,here('results/ALMANAC_klaeger_johnson_models/expression_feature_interactors.rds'))
```
