...
```{r}
# read in data
importance_values <- read_csv(here("results/ALMANAC_klaeger_johnson_models/breast_cancer_models/feature_importances_all_kinases_forced_in.csv")) %>%
    drop_na()
...
ggsave(here("figures/ALMANAC_klaeger_johnson/inhibition_importance_figure.png"), height = 6, width = 10.5, units = "cm")
...
ggsave(here("figures/ALMANAC_klaeger_johnson/expression_importance_figure.png"), height = 6, width = 10.5, units = "cm")
