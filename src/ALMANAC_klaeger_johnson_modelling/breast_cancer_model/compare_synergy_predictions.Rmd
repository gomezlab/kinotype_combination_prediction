...
prediction_sesnitivity_scores_all = read_csv(here('results/ALMANAC_klaeger_johnson_models/breast_cancer_models/prediction_sensitivity_scores_all.csv'))
...
predicted_vs_validated_synergy_scores_for_plot = predicted_vs_validated_synergy_scores %>%
  mutate(synergy_metric = fct_relevel(synergy_metric, levels = c("HSA", "Loewe", "ZIP", "Bliss")))  %>% 
