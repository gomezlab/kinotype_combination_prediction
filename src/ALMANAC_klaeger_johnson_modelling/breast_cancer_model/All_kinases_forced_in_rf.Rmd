---
title: "Modelling Breast Cancer Cell Lines including all kinase features with random forest"
...
set.seed(2222)
folds = vfold_cv(ALMANAC_klaeger_johnson_CCLE_data, v = 5)
...
write_csv(results, here('results/ALMANAC_klaeger_johnson_models/breast_cancer_models/ALMANAC_klaeger_johnson_lasso_xgboost_all_tuning_results_all_kinases_forced_in_rf.csv'))
```
