...
```{r}
#extract best model
model_metrics_combined = read_csv(here('results/PRISM_LINCS_klaeger_ic50_models_classification_metrics.csv'))
...
results <- fit_resamples(
	...
	write_rds(here('results/final_tuned_PRISM_LINCS_klaeger_classification_model_model.rds'))
toc()
...
c = a + b + plot_annotation(
	title = "PRISM-Kinomescan-Klaeger xgboost classification model results"
)

ggsave(here('figures/final_tuned_PRISM_LINCS_klaeger_classification_model.png'))
```
